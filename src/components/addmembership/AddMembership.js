  ...
  return (
    <div className='text-black'>
      ...
      <div className='flex gap-10 mb-10'>
          <input value={inputField.months} onChange={(value)=>{handleOnchange(value,"months")}} className='border-2 rounded-lg text-lg w-1/3 h-1/2 p-2' type='number' placeholder='Add No. of Months' />
          <input value={inputField.price} onChange={(value)=>{handleOnchange(value,"price")}} className='border-2 rounded-lg text-lg w-1/3 h-1/2 p-2' type='number' placeholder='Add Price' />
