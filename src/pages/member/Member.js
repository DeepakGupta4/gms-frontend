    ...
    <div className='text-black p-5 w-3/4 h-[100vh]'>
        ...
        <div className='mt-5 text-xl flex justify-between text-slate-900'>
          ...
          <div className='flex gap-5'>
              ...
              <div className={`w-8 h-8 cursor-pointer border-2 flex items-center justify-center hover:text-white hover:bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 ${currentPage===1?'bg-gray-200 text-gray-50':null}`} onClick={()=>{handlePrev()}}><ChevronLeftIcon /></div>
              <div className={`w-8 h-8 cursor-pointer border-2 flex items-center justify-center hover:text-white hover:bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 ${currentPage===noOfPage?'bg-gray-200 text-gray-50':null}`} onClick={()=>{handleNext()}}><ChevronRightIcon/></div>
          </div>
        </div>
